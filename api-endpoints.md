...
GET `<instanceUrl>/api/v1/deploy?uuid=<resourceUuid>`
...
ResourceUuid could be found in the URL of the resource page.

:::tip
There will be endpoint for gathering uuids of all resources soon.
:::
